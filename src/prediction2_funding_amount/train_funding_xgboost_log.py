...
print("=" * 60)
print("FUNDING AMOUNT - LOG-TARGET XGBOOST REGRESSION")
print("=" * 60)
...
joblib.dump(
    model,
    "models/funding_amount_xgboost_log.pkl"
)

print("\nLog-target XGBoost model saved to:")
print("models/funding_amount_xgboost_log.pkl")

print("\n" + "=" * 60)
print("LOG-TARGET XGBOOST REGRESSION COMPLETED")
print("=" * 60)